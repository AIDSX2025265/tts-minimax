        ...
        <header className="border-b border-white/10 backdrop-blur-md bg-black/20">
          <div className="max-w-4xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={() => signOut()} className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg text-sm transition">
                退出
              </button>
            </div>
          </div>
        ...
        <main className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* 音色选择 */}
              <div>
                <label className="block text-white/60 text-sm mb-2">音色</label>
                <select 
                  value={voice} 
              ...
              {/* 情感选择 */}
              <div>
                <label className="block text-white/60 text-sm mb-2">情感</label>
                <select 
                  value={emotion} 
              ...
              {/* 语速选择 */}
              <div>
                <label className="block text-white/60 text-sm mb-2">语速</label>
                <select 
                  value={speed} 
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 mb-8">
            ...
            <div className="flex justify-between items-center mt-4">
              <span className="text-white/40 text-sm">{text.length} / 1000 字符</span>
              <button
                ...
                {history.map((item, i) => (
                  <div key={i} className="flex items-center gap-4 p-3 bg-white/5 rounded-xl hover:bg-white/10 transition cursor-pointer" onClick={() => setAudioUrl(item.url)}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-white/40 text-xs">{item.time} · {item.voice}</p>
                    </div>
