        ...
        <header className={`border-b ${theme.header} backdrop-blur-md`}>
          <div className="max-w-4xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <button onClick={toggleDarkMode} className="p-2 rounded-lg bg-green-900/50 text-green-300 hover:bg-green-800/50 transition">
                {darkMode ? (
          ...
          <div className={`${theme.card} backdrop-blur-sm border rounded-2xl p-6 mb-8`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select value={emotion} onChange={(e) => setEmotion(e.target.value)} className={`w-full p-3 ${theme.select} rounded-xl focus:outline-none focus:border-green-500`}>
              ...
              <div>
                ...
                <select value={speed} onChange={(e) => setSpeed(Number(e.target.value))} className={`w-full p-3 ${theme.select} rounded-xl focus:outline-none focus:border-green-500`}>
                ...
                {history.map((item, i) => (
                  <div key={i} className="flex items-center gap-4 p-3 bg-black/20 rounded-xl hover:bg-black/40 transition cursor-pointer" onClick={() => setAudioUrl(item.url)}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-green-600 text-xs">{item.time}</p>
                    </div>
